...
public class Desafio1040 {
	...
	public static void main(String[] args) {
		 ...
		 * média calculada for inferior a 5.0, imprima a mensagem 
		 * "Aluno reprovado.". Se a média calculada for um valor 
		 ...
		 * média (some a pontuação do exame com a média anteriormente calculada 
		 * e divida por 2). e imprima a mensagem "Aluno aprovado." (caso a média 
		 * final seja 5.0 ou mais ) ou "Aluno reprovado.", (caso a média tenha 
		 * ficado 4.9 ou menos). Para estes dois casos (aprovado ou reprovado 
		 * após ter pego exame) apresente na última linha uma mensagem "Media 
		 ...
		 * esqueça de imprimir o enter após o final de cada linha, caso 
